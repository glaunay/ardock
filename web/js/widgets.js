    ...
    this.scaffold (
         ...
         + '<header id="w_' + this.idNum + '" class="container-fluid header widget">'
                                ...
                                +'<div class="header-core jumbotron" id="headerCore">'
                                    ...
                                    +'<p>We have shown that the random probes interact in a non-random manner on protein surfaces, and that targeted regions are enriched in biological interfaces.</br>Docking is performed by the Hex software using spherical polar Fourier Correlations.</p>'
                                    + '<quote>Reference: <span class="text-number">1</span>. Reille S., Garnier M., Robert X., Gouet P., Martin J., Launay G. Identification and visualization of protein binding regions with the ArDock server. Nucleic Acids Res. <span class="text-number">2018;46(W1):W417-W422.</span>'
                                    +'</quote>'
                                    +'</br><quote>Reference: <span class="text-number">2</span>. Martin J, Lavery R. Arbitrary protein-protein docking targets biologically relevant interfaces. BMC Biophysics <span class="text-number">2012;5(1):7.</span>'
                                    +'</quote>'
